            ...
            {activities.map((activity, index) => (
              ...
              >
                <motion.div
                  ...
                  viewport={{ once: true }}
                  whileHover={{ y: -8 }}
                  className="group relative overflow-hidden rounded-xl border border-border-custom hover:border-emerald transition-all duration-300 bg-white cursor-pointer"
                >
                  {/* Image */}
