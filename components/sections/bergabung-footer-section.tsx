...
export default function BergabungFooterSection() {
  const stats = [
    ...
    { icon: TrendingUp, value: "10+", label: "Kegiatan/Tahun" },
    { icon: Calendar, value: "1,000+", label: "Alumni Sejak 2002" },
    { icon: Award, value: "6", label: "Departemen Aktif" },
  ]

  return (
    <section
      id="gabung"
      className="relative bg-gradient-to-b from-emerald-deeper via-emerald-dark to-emerald-deeper py-20"
      style={{
      ...
      <div className="relative container mx-auto px-6 max-w-6xl">
        ...
        <div className="text-center mb-20">
          <a href="/bergabung">
            <Button
              size="lg"
              className="bg-emerald hover:bg-emerald-dark text-white font-bold text-xl px-12 py-6 rounded-lg transition-all duration-300 hover:scale-105 uppercase tracking-wide shadow-2xl"
            >
              JOIN IPM NOW →
            </Button>
          </a>
