  ...
  const fetchTestimonial = async () => {
    try {
      ...
      if (data.success) {
        ...
        setDistrict(data.testimonial.district || '')
        setQuote(data.testimonial.quote)
        setPhotoPreview(data.testimonial.photo_url)
      } else {
        toast({
          title: "Error",
          description: data.error || "Failed to fetch testimonial",
          variant: "destructive",
        })
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update the information below to modify the testimonial</CardDescription>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="text-center">
                    ...
                    <label htmlFor="photo" className="cursor-pointer">
                      <span className="text-emerald-600 hover:text-emerald-700 font-medium">
                        {removePhoto ? 'Upload new photo' : 'Replace photo'}
                      </span>
                      <span className="text-gray-500"> or leave for avatar</span>
                    </label>
                    <input
                      id="photo"
                      type="file"
