              ...
              <div className="flex flex-col items-center text-center">
                {kepala.photo ? (
                  <Image
                    ...
                    width={120}
                    height={120}
                    className="rounded-full object-cover border-4 border-gray-100 mb-4"
                  />
                ) : (
                  <div className={`w-30 h-30 rounded-full ${colors.bg} flex items-center justify-center mb-4 border-4 border-gray-100`}>
                    <User className={`w-16 h-16 ${colors.text}`} />
                  </div>
                )}
                    ...
                    <div className="flex flex-col items-center text-center">
                      {member.photo ? (
                        <Image
                          ...
                          width={80}
                          height={80}
                          className="rounded-full object-cover border-2 border-gray-100 mb-3"
                        />
                      ) : (
                        <div className={`w-20 h-20 rounded-full ${colors.bg} flex items-center justify-center mb-3 border-2 border-gray-100`}>
